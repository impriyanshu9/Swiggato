...
function PaymentForm ()  {
    ...
    const [proceedClicked, setProceedClicked] = useState(false); // New state
    ...
    const GST_RATE = 0.05; // GST rate (18%)
    const DELIVERY_CHARGE = 50; // Delivery charge in Rs
    ...
    const calculateTotalPriceForCart = () => {
      ...
      // Calculate total amount with GST and delivery charges
  ...
  const handleProceedClick = () => {
    ...
    openCity('Credit Card'); // Change this to the tab you want to open after clicking "Proceed"
  };
  ...
  return (
    ...
    <p>Delivery Charge: Rs{DELIVERY_CHARGE}</p>
        ...
        disabled={!cartItems.length} // Disable if the cart is empty
      >
        Proceed
      </button>
        </div>
